...
class RedisService:
    ...
    async def get_client(self) -> aioredis.Redis:
        if self._client is None:
            # Standalone — Azure Cache for Redis enruta a través del endpoint
            # principal. El error MOVED en operaciones de escritura se maneja
            # en cada call site (ver sso_router.py sso_exchange).
