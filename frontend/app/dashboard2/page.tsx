  ...
  function CardContent({ app, isLaunching }: { app: App; isLaunching: boolean }) {
    ...
    return (
      <>
        ...
        {/* Info */}
        <p className="text-[14px] font-bold text-[#13294B] mb-0.5">{app.name}</p>
        <p className="text-[11px] font-medium text-slate-400 mb-1.5">{app.sub}</p>
        <p className="text-[12px] text-slate-500 leading-relaxed">{app.desc}</p>
